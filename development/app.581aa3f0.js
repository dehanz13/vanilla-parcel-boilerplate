...
},{"regenerator-runtime":"../node_modules/regenerator-runtime/runtime.js"}],"../src/components/pages/About.js":[function(require,module,exports) {
"use strict";
...
},{}],"../src/components/pages/Contact.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            console.log(user);
            template = "\n\t\t<div class=\"card\">\n\t\t\t<img src=\"".concat(user.picture.large, "\" />\n\t\t\t<div class=\"card-body\">\n\t\t\t\t<h1>").concat(user.name.first, " ").concat(user.name.last, "</h1>\n\t\t\t\t<ul>\n\t\t\t\t\t<li><a href=\"#\">").concat(user.email, "</a></li>\n\t\t\t\t\t<li><a href=\"#\">").concat(user.phone, "</a></li>\n\t\t\t\t\t<li><a href=\"#\">").concat(user.location.city, "</a></li>\n\t\t\t\t</ul>\n\t\t\t<div>\n\t\t<div>\n\t");
  ...
  var _ref = (0, _asyncToGenerator2.default)( /*#__PURE__*/_regenerator.default.mark(function _callee() {
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            document.getElementById("navbar-content").innerHTML = (0, _Navbar.default)();
            document.getElementById("hero").innerHTML = (0, _Hero.default)(); // document.getElementById("user").innerHTML = await User();
...
app();
},{"@babel/runtime-corejs2/helpers/asyncToGenerator":"../node_modules/@babel/runtime-corejs2/helpers/asyncToGenerator.js","@babel/runtime-corejs2/regenerator":"../node_modules/@babel/runtime-corejs2/regenerator/index.js","./components/pages/About":"../src/components/pages/About.js","./components/pages/Contact":"../src/components/pages/Contact.js","./components/Hero":"../src/components/Hero.js","./components/Navbar":"../src/components/Navbar.js","./components/User":"../src/components/User.js","./scss/app.scss":"../src/scss/app.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
